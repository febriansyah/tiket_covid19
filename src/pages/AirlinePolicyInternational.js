...
class AirlinePolicyInternational extends Component{
  ...
  loadUsers = () => {
    this.setState({ isLoading: true}, () => {
      ...
      request
        .get('https://api.tiketsafe.com/api/v2/airlines?lang='+this.state.defaultLangnya+'&flightType=2&page='+this.state.paging)
        .then((results) => {   
			    ...
			    <section id="section_innernya">
					...
					<div className="rows">
						<div className="tabs_main_menu">
							<Link to="/AirlinePolicyDomestic" className="tabs_menu">
...
export default AirlinePolicyInternational;
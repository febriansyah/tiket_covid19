		...
		return(
			<div>
					    	...
					    	<div className="inner_popup">
					    		...
					    		<div className="form_row">
						    		<div className="form_group">
						    			<button className="block_blue_bt trigger_close_popup" type="button" onClick={this.popupCLose2()} >Ok </button>
						    		</div>
					    		</div> {/* end.form_row */}
					    	</div> {/* end.inner_popup */}
				...
				<div id="popup_email" className="popup_slider hide">
					...
					<div className="content_slide_btm">
					    <div className="box_popup_search_auto">
					    	<div onClick={this.popupCLose2()}  className="button_close_popup trigger_close_popup"><img src={this.state.imageSrc} className="icon_close_popup" /></div>
					    	<div className="inner_popup">
